...
>>>>>>> 3e0caf5eed40cb99118bfa376703523a82a26be3
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle">Tạo Phiếu Thuê Phòng</h5>
            ...
            <div class="modal-body">
                <form class=""style={{ width:"100%"}}>
                    <div class="form-group row">
                        <label for="roomId" class="col-md-3 col-form-label">Số phòng</label>
                        <div className='col-md-9'>
                            <input type="text" class="form-control" id="roomId" placeholder="Vd:101" />
                        </div>  
                    </div>


                    <div class="form-group row">
                        <label for="startDate" class="col-md-3 col-form-label" >Ngày bắt đầu thuê</label>
                        <div className='col-md-9'>
                    ...
                    <div className="customerList">
                        <table class="table table-sm">
                            <thead className="text-center">
                                ...
                                <th scope="col" style={{width:'250px'}}>CMND</th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control" placeholder="Nhập tên khách hàng"/></td>
                                    <td >
                                    ...
                                    <td ><input type="text" class="form-control"  placeholder="Số CMND" /></td>
                                    <td><input type="text" class="form-control" placeholder="Vd: quận 2, Tp HCM" /></td>
                                </tr>
                                <tr>
                                    <th scope="row" className="STT"></th>
                                    <td><input type="text" class="form-control" placeholder="Nhập tên khách hàng"/></td>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary">Tạo Phiếu Thuê</button>
            </div>
            </div>
        </div>
        </div>
